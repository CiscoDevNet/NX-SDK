...
\subsubsection[{execShowCmd}]{\setlength{\rightskip}{0pt plus 5cm}virtual char$\ast$ nxos::NxCliParser::execShowCmd (std::string {\em show\_\-syntax}, \/  nxos::record\_\-type\_\-e {\em type} = {\ttfamily nxos::R\_\-TEXT}, \/  virtual char $\ast$ {\em execConfigCmd}const char $\ast$filename = {\ttfamily 0;bool~$\ast$oper\_\-result=NULL})\hspace{0.3cm}{\ttfamily  \mbox{[}pure virtual\mbox{]}}}}
