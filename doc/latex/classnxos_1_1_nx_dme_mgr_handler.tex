...
\index{nxos\+::\+Nx\+Dme\+Mgr\+Handler@{nxos\+::\+Nx\+Dme\+Mgr\+Handler}!````~Nx\+Dme\+Mgr\+Handler@{$\sim$\+Nx\+Dme\+Mgr\+Handler}}
\index{````~Nx\+Dme\+Mgr\+Handler@{$\sim$\+Nx\+Dme\+Mgr\+Handler}!nxos\+::\+Nx\+Dme\+Mgr\+Handler@{nxos\+::\+Nx\+Dme\+Mgr\+Handler}}
\subsubsection{\texorpdfstring{$\sim$\+Nx\+Dme\+Mgr\+Handler()}{~NxDmeMgrHandler()}}
