...
C++:
     NxVrf *vrf;
     vrf = ribMgr->getVrf(\textcolor{stringliteral}{"default"});
     cout << \textcolor{stringliteral}{"IPv4 Table Id: "} << vrf->getTableId(\mbox{\hyperlink{namespacenxos_a3a667f48b94db10aa398940dc5bf72d7a038f37de02a2c9ee1acbc4e184583628}{nxos::AF\_IPV4}});
