...
if not os.path.exists(env_file):
	sys.exit("%s does not exist" % (env_file))
...
def copy_files(spec_file_path, rpm_file_path):
	...
	print("SPEC file: " + spec_file_dest + os.path.basename(spec_file_path))
...
def write_spec():
	...
	custom_spec_lines = []
	with open(custom_spec_file_path, 'r') as custom_spec_file:
		custom_spec_lines = custom_spec_file.readlines()
	...
	with open(spec_file_path, 'w') as spec_file:
		...
		spec_file.writelines(custom_spec_lines)
...
def main():
	...
	if not os.path.isdir(enxos_sdk_path):
		sys.exit(enxos_sdk_path + " not found")
	
	if not os.path.isdir(nxsdk_path):
		sys.exit(nxsdk_path + " not found")
	...
	print("RPM Package: %s" % (rpm_file_path))
