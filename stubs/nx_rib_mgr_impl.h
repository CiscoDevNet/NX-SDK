...
public:
    ...
    NxL3NextHop* getL3NextHop(const std::string &address,const std::string &intfName="");
    ...
    NxL3NextHop* addL3DirectNextHop(const std::string &nextHopAddr,const std::string &intfName,uint8_t preference);
    NxL3NextHop* addL3RecursiveNextHop(const std::string &nextHopAddr,uint8_t preference);
    bool delL3NextHop(const std::string &nexHopAddress,const std::string &intfName="");
    std::string getL3Prefix() const;
};
...
public:
    ...
    NxL3Route* getL3RouteDetail(const std::string &routeAddr,unsigned int maskLen = 0,const std::string &vrfName ="default");
    NxL3Route* addL3Route(const std::string &routeAddr,unsigned char maskLen =0,const std::string &vrfName="default");
    bool delL3Route(const std::string &routePrefix,unsigned char maskLen =0,const std::string &vrfName ="default");
    bool sendMyL3RoutesToRib(nxos::af_e af=nxos::AF_IPV4);
    bool converged(nxos::af_e af=nxos::AF_IPV4,const std::string &vrfName="all");
};
}
