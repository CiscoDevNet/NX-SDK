...
public:
    ...
    nxos::record_type_e showCliOutFormat();
};
...
public:
    ...
    char* execConfigCmd(const char *filename_cmd, bool isfilename);
    nxos::err_type_e addTechSupport(string show_cmd_group = "", bool add_internals = true);
};
}
